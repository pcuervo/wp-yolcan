...
<ul class="subsubsub">
	...
	$current_por_clube = $_GET['page'] == 'por_club' ? 'current' : '';?>
	...
	<?php if(!isset($_GET['club'])):?>
		<li class="por-clube"><a href="<?php echo admin_url().'admin.php?page=por_club'; ?>" class="<?php echo $current_por_clube; ?>">Por club</a></li>
	<?php else: ?>
		<li class="por-clube"><a href="<?php echo admin_url().'admin.php?page=por_club'; ?>" class="<?php echo $current_por_clube; ?>">Ver otro club</a></li>
	<?php endif; ?>
</ul>