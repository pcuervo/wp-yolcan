...
This bundles functionality to process credit cards and offline payments securely as well as send email notifications to your customers when they complete a successful purchase.
...
* Offline payments implemented (OXXO, SPEI, Banorte)
...
= 0.4.0 =
* Added Banorte payment method.
* Fix compatibility issues.
* Fix email instructions warning.