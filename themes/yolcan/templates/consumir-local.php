	...
	<div class="[ container ]">
		<div class="[ row ][ color-light ]">
			<article class="[ col-xs-12 ]">
				...
				<p class="[ lead ]">Comprando productos locales estas apoyando a los productorores de tu comunidad.</p>
			...
			<article class="[ col-sm-7 col-lg-6 ]">
				<p class=""> Los productos cultivaddos con métodos de agricultura intensiva son más baratos porque contienen químicos que dañarán tu salud y la de tu familia.</p>
			...
			<article class="[ col-xs-12 col-sm-5 col-lg-4 col-lg-offset-1 ] ">
